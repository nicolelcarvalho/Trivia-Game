...
var questionsArray = ["What did Kramer write a book about?", "What item did Jerry accidentally agree </br> to promote on live TV?", "What is Elaine notoriously bad at?", "What food item did Newman picture Kramer to be?", "What snack did Jerry and Kramer accidentally drop </br> inside the patient in the operating room?", "Newman is almost evicted from</br> his apartment for doing what?", "George purchased what arcade game to save his high score?", "What did George's fiance die from?", "What group gift did George hide from the gang </br> in his apartment for as long as he could?", "Who is the Co-creator of Seinfeld along with Jerry Seinfeld?"];
